...
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 2201))', 'n_signatures \u2265 2201', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 4260))', 'n_signatures \u2265 4260', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 4276))', 'n_signatures \u2265 4276', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 22227))', 'n_signatures \u2265 22227', prefix = 'collect-classes-from-hierarchical-partition')
...
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 2201))', 'n_signatures \u2265 2201', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 4260))', 'n_signatures \u2265 4260', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 4276))', 'n_signatures \u2265 4276', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 22227))', 'n_signatures \u2265 22227', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
...
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1491),
    method = "UMAP", top_value_method = "ATC", top_n = 40000, scale_rows = TRUE)', 'n_signatures \u2265 1491', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 2201),
    method = "UMAP", top_value_method = "SD", top_n = 40000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 2201),
    method = "UMAP", top_value_method = "ATC", top_n = 40000, scale_rows = TRUE)', 'n_signatures \u2265 2201', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 4260),
    method = "UMAP", top_value_method = "SD", top_n = 40000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 4260),
    method = "UMAP", top_value_method = "ATC", top_n = 40000, scale_rows = TRUE)', 'n_signatures \u2265 4260', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 4276),
    method = "UMAP", top_value_method = "SD", top_n = 40000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 4276),
    method = "UMAP", top_value_method = "ATC", top_n = 40000, scale_rows = TRUE)', 'n_signatures \u2265 4276', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 22227),
    method = "UMAP", top_value_method = "SD", top_n = 40000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 22227),
    method = "UMAP", top_value_method = "ATC", top_n = 40000, scale_rows = TRUE)', 'n_signatures \u2265 22227', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
...
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 2201))', 'n_signatures \u2265 2201', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 4260))', 'n_signatures \u2265 4260', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 4276))', 'n_signatures \u2265 4276', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 22227))', 'n_signatures \u2265 22227', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
